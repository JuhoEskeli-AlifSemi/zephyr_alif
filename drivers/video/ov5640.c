...
static const struct ov5640_reg dvp_2592x1944_res_params[] = {
	...
	/* PLL: boost PCLK for QSXGA (~84MHz for 15fps) */
	{0x3035, 0x21}, {0x3036, 0x69}, {0x3037, 0x13},
	/* Clamp exposure within VTS (1968) to prevent frame stretching */
	{0x3503, 0x01}, /* AEC manual, AGC auto */
